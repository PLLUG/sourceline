...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_SettingsPage_t, stringdata) + ofs \
...
QT_MOC_LITERAL(3, 24, 10)
    ...
    "SettingsPage\0slotApply\0\0slotCancel"
};
...
const QMetaObject SettingsPage::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_SettingsPage.data,
      qt_meta_data_SettingsPage,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_SettingsPage.stringdata))
