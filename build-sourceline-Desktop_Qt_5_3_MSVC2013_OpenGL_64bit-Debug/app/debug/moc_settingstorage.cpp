...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_SettingStorage_t, stringdata) + ofs \
...
const QMetaObject SettingStorage::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_SettingStorage.data,
      qt_meta_data_SettingStorage,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_SettingStorage.stringdata))
