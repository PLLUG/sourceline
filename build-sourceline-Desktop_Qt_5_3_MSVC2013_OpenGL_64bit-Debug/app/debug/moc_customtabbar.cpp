...
#include "../../../src/app/ui/customtabbar.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_CustomTabBar_t, stringdata) + ofs \
...
QT_MOC_LITERAL(5, 36, 12)
    ...
    "CustomTabBar\0slotAddTab\0\0index\0name\0"
    "slotCloseTab"
};
...
void CustomTabBar::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        CustomTabBar *_t = static_cast<CustomTabBar *>(_o);
        switch (_id) {
        case 0: _t->slotAddTab((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< QString(*)>(_a[2]))); break;
        case 1: _t->slotCloseTab((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    }
}
...
const QMetaObject CustomTabBar::staticMetaObject = {
    { &QTabBar::staticMetaObject, qt_meta_stringdata_CustomTabBar.data,
      qt_meta_data_CustomTabBar,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_CustomTabBar.stringdata))
