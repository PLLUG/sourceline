...
const QMetaObject PluginManager::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_PluginManager.data,
      qt_meta_data_PluginManager,  qt_static_metacall, 0, 0}
};
...
int PluginManager::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: *reinterpret_cast< QStringList*>(_v) = activePlugins(); break;
        default: break;
        }
        _id -= 1;
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: slotSetActivePlugins(*reinterpret_cast< QStringList*>(_v)); break;
        default: break;
        }
        _id -= 1;
