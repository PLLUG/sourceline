...
RevisionNode *CreateTree::create() const
{
    ...
    addCommit(branch, createSimpleNode("My brunch: second commit", QString("%1").arg(revCount++)));
    addCommit(branch, createSimpleNode("My brunch: third commit", QString("%1").arg(revCount++)));
