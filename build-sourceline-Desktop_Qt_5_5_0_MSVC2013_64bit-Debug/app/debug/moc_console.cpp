...
#include "../../../src/app/ui/console/console.h"
...
QT_MOC_LITERAL(4, 22, 13) // "signalSendCmd"

    },
    "Console\0getData\0\0data\0signalSendCmd"
};
...
void Console::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->signalSendCmd((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
        ...
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Console::signalSendCmd)) {
                *result = 1;
            }
        }
    }
...
// SIGNAL 1
void Console::signalSendCmd(QString _t1)
{
    void *_a[] = { Q_NULLPTR, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
